...
--nThreads 1  --customise PhysicsTools/PFNano/pfnano_cff.PFnano_customizeMC$NOINPUTS  $NO_EXEC $PARALLEL
...
--nThreads 1  --customise PhysicsTools/PFNano/pfnano_cff.PFnano_customizeData$NOINPUTS  $NO_EXEC $PARALLEL
