...
def addPFCands(process, runOnMC=False, allPF = False, onlyAK4=False, onlyAK8=False, addLS=False):
    ...
    #if addLS:
    # addLSJets(process, pfCandLabel="customAK8ConstituentsTable:pfCandsNoLep", runOnMC=False)
    ...
    def producePF(process) :    
        ...
        from PhysicsTools.NanoAODJMAR.leptonLessPFProducer_cff import leptonLessPFProducer
    ...
    def LSjetsequence(process,runOnMC):
        ...
        jetToolbox(process, 'ak8',  'jetSequence','noOutput',PUMethod = 'Puppi', postFix='NoLep', newPFCollection=True, nameNewPFCollection='leptonLesspuppi', 
                   JETCorrPayload = 'AK8PFPuppi', JETCorrLevels = JETCorrLevels,
                   runOnMC=runOnMc, addSoftDrop=True, addSoftDropSubjets=True, addNsub=True, 
